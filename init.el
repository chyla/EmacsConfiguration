...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (markdown-mode diff-hl goto-chg highlight-symbol flycheck multi-compile ace-window find-file-in-project ivy magit company yasnippet yasnippet-snippets chyla-theme))))
(custom-set-faces
